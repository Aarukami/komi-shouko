...
from KomiRobot import pbot as app 
from KomiRobot import arq
from KomiRobot.services.keyboard import Ikb
from KomiRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from KomiRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from KomiRobot.services.types import InlineQueryResultCachedDocument
from KomiRobot.modules.info import get_chat_info, get_user_info
from KomiRobot.utils.functions import test_speedtest
from KomiRobot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://te.legra.ph/file/940c824b2b77d3a84e719.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/KomiXrobot"),
        InlineKeyboardButton(
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER BOT](t.me/girls_lob)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://te.legra.ph/file/a1e81fca246eac0b0f413.jpg",
            input_message_content=InputTextMessageContent(
