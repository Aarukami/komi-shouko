...
import sys
import traceback
import KomiRobot.modules.sql.users_sql as sql
...
PM_START_TEXT = """
*Hello {} !* 
✪ Your Welcome in Bonten [.](https://te.legra.ph/file/d86d1dd73d57602b0ce7f.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
KOMISTART = "https://te.legra.ph/file/d86d1dd73d57602b0ce7f.jpg"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                          text="「HELP」", url=f"https://t.me/izanasamabot?start=help"
                        ),  
                    ]
                ]
            ),
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}", 
                f"""**[Izana kurokawa](https://te.legra.ph/file/d86d1dd73d57602b0ce7f.jpg) Started!**
...
**Telegram Library:** `v{peler}`""",
    ...
    komi_callback_handler = CallbackQueryHandler(
        komi_about_callback, pattern=r"komi_button", run_async=True
    )
    ...
    dispatcher.add_handler(komi_callback_handler)
    ...
    if WEBHOOK:
        ...
        LOGGER.info("@IzanasamaBot bot starting.")
