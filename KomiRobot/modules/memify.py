...
from KomiRobot import LOGGER, TEMP_DOWNLOAD_DIRECTORY, telethn as bot
...
async def handler(event):
    ...
    msg = await event.reply("**Komi making your sticker**...")
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./KomiRobot/resources/fonts/default.ttf"
