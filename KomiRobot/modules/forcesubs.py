...
from KomiRobot import DRAGONS as SUDO_USERS
from KomiRobot import pbot
from KomiRobot.modules.sql import forceSubscribe_sql as sql
...
❂ Komi can mute members who are not subscribed your channel until they subscribe
