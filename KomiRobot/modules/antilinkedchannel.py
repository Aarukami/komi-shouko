...
from KomiRobot.modules.helper_funcs.decorators import siestamsg, siestacmd
from KomiRobot.modules.helper_funcs.anonymous import user_admin, AdminPerms
import KomiRobot.modules.sql.antilinkedchannel_sql as sql


@siestacmd(command="antilinkedchan", group=112)
@bot_can_delete
...
@siestamsg(Filters.is_automatic_forward, group=111)
...
@siestacmd(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@siestamsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
