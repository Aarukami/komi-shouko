...
import KomiRobot.modules.sql.global_bans_sql as gban_sql
import KomiRobot.modules.sql.users_sql as user_sql
from KomiRobot import DEV_USERS, OWNER_ID, dispatcher
