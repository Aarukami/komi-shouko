...
def aki_lead_cb_handler(update: Update, context:CallbackContext) -> None:
    ...
    dispatcher.add_handler(CommandHandler('language', aki_lang, run_async=True))
    dispatcher.add_handler(CommandHandler('childmode', aki_childmode, run_async=True))
    dispatcher.add_handler(CommandHandler('leaderboard', aki_lead, run_async=True))

    dispatcher.add_handler(CallbackQueryHandler(aki_set_lang, pattern=r"aki_set_lang_", run_async=True))
    dispatcher.add_handler(CallbackQueryHandler(aki_set_child_mode, pattern=r"c_mode_", run_async=True))
    dispatcher.add_handler(CallbackQueryHandler(aki_play_callback_handler, pattern=r"aki_play_", run_async=True))
    dispatcher.add_handler(CallbackQueryHandler(aki_win, pattern=r"aki_win_", run_async=True))
    dispatcher.add_handler(CallbackQueryHandler(aki_lead_cb_handler, pattern=r"aki_lead_", run_async=True))
